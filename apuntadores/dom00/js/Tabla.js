var Tabla = (function (){
    ...
    var existe = function(obj_tabla, fila, columna){
        if(obj_tabla.children[1].rows[fila-1] === undefined)
            return false;
        if(obj_tabla.children[1].rows[fila-1].children[columna] === undefined)
            return false;
        if(obj_tabla.children[1].rows[fila-1].children[columna].nodeName !== 'TD')
            return false;
        return true;
    }
    ...
    var celda = function(obj_tabla, fila, columna){
        if(existe(obj_tabla, fila, columna))
            return obj_tabla.children[1].rows[fila-1].children[columna];
    }
